...
export function createAuthEmbed(authUrl: string): Result<EmbedBuilder, Error> {
  try {
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        'Bitte authentifizieren Sie sich mit Ihrem schulischen Microsoft-Konto. Nachdem Sie fertig sind, drücken Sie "Verify", um Zugriff auf den Server zu erhalten.'
      )
      .setURL(authUrl)
      .setColor("Blue");
